...
q = input("input 'shutdown' to exit, Press 'Enter' to Open the application")
if q == "shutdown":
...
urlField = Entry(main, font=("Times New Roman", 10), justify=CENTER)
urlField.pack(side=TOP, fill=X, padx=10, pady=15)


dBtn = Button(main, text="Start Download", font=(
    "Times New Roman", 18), relief='ridge', activeforeground='red', command=start_download_thread)
dBtn.pack(side=TOP)
